...
class Store extends EventTarget {
    ...
    async sync () {
        await chrome.storage.sync.set({
            ...
            action_preview_font_size: this.action_preview_font_size,
            action_preview_font_color: this.action_preview_font_color,
            action_preview_background_color: this.action_preview_background_color,
            ...
            line_color_1: this.line_color_1,
            line_color_2: this.line_color_2,
        });
        this.changed = false;
        this.dispatchEvent(new Event('Store:changed'));
    }
