...
export const default_sampling_period = 5;
export const default_threshold_angle = 45;
export const default_scroll_factor = 0.9;

export const default_use_draw_line = true;
export const default_use_action_preview = true;
export const default_action_preview_x_offset = 20;
export const default_action_preview_y_offset = 0;
